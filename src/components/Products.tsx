            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    <div className="max-w-2xl">
                        <h2 className="text-blue-600 font-bold tracking-wider uppercase text-sm mb-4 text-left">Inventory</h2>
                        <h3 className="text-4xl md:text-5xl font-bold text-gray-900 font-poppins text-left">Quality Electronic Spare Parts</h3>
                    </div>
                    <p className="text-gray-600 max-w-md text-left md:text-right">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    {products.map((product, index) => (
                        <div
                            key={index}
                            className="bg-white rounded-3xl p-4 border border-gray-100 shadow-sm hover:shadow-xl transition-all group overflow-hidden"
                        >
                            ...
                            <a
                                ...
                                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gray-50 text-gray-900 border border-gray-100 font-bold text-sm hover:bg-whatsapp hover:text-white hover:border-whatsapp transition-all"
                            >
